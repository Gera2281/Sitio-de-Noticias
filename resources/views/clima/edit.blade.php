...
@section('titulo', 'Editar Noticia - Clima')
...
<div class="container mt-4" style="max-width: 700px;">
    ...
    <h2 class="mb-4">Editar noticia de Clima</h2>
    ...
    <form action="{{ route('clima.update', $clima) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            @if($clima->imagen)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $clima->imagen) }}" alt="Imagen actual" class="img-thumbnail" style="max-height: 200px;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('titulo') is-invalid @enderror"
                   id="titulo" name="titulo" value="{{ old('titulo', $clima->titulo) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('descripcion') is-invalid @enderror"
                   id="descripcion" name="descripcion" value="{{ old('descripcion', $clima->descripcion) }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('contenido') is-invalid @enderror"
                      id="contenido" name="contenido" rows="6">{{ old('contenido', $clima->contenido) }}</textarea>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('clima.index') }}" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
@endsection
